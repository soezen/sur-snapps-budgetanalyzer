...
INSERT into tokens values(1, 'de2f7740-bd39-4c08-a4b7-cd760f435c9e', 1, 'valid@test.com', CURRENT_DATE + 1 MONTH, 'VALID', 'USER_INVITATION');
insert into tokens values(2, 'test-revoked', 1, 'revoke@test.com', CURRENT_DATE + 1 MONTH, 'REVOKED', 'USER_INVITATION');
insert into tokens values(3, 'test-expired', 1, 'expired@test.com', CURRENT_DATE - 1 DAY, 'VALID', 'USER_INVITATION');